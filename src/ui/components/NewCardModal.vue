...
<template>
	<Transition name="surface">
		...
		>
			<aside
				class="modal-panel app-scroll grid max-h-[min(840px,calc(100vh-64px))] w-[min(780px,94vw)] content-start overflow-auto rounded-[2px] border border-border/75 bg-[linear-gradient(180deg,hsl(var(--card))_0%,hsl(var(--card)/0.96)_100%)] shadow-[0_1px_0_hsl(0_0%_100%/0.04),0_26px_60px_hsl(0_0%_0%/0.42)]"
			>
